BLR2 <-
function (y, XF = NULL, XR = NULL, XL = NULL, GF = list(ID = NULL, A = NULL), 
                prior = NULL, nIter = 8000, burnIn = 500, thin = 1, update=200, 
                thin2 = 1e+10, minAbsBeta = 1e-09, weights = NULL, saveAt=saveAt) 
{
